...
- What, in your opinion, is an important part of code reviews? That is, what is
  ...
  - Something that I pay attention to is the idea that code is read far more than
  it is written, therefore readability should always 'trump' writing speed/cutting
  corners. So when the code is reviewed, I pay attention to and appreciate when others
  how it can be read by someone with absolutely no context. It is so important to document
  well. Whether they are a new developer or someone switching contexts, its super helpful.
  I also like this because it removes any 'yeah but they should know' from the equation.
  
- We have an awful lot of computers here, and it gets pretty confusing with
  slightly different things running on all of them. How could containers help us
  improve this situation?
  
  - Containers help you improve this situation by abracting the environment and it's 
  dependencies away from said computers local environments. This allows anyone 
  to pull down a container and run it without any hassle (or knowledge really) 
  of what is required to run it. This is an incredible feat really. Anyone, with access,
  can pull down a container from anywhere (with internet access) and instantly run
  anything you provided in said container. Collaborating and speed are just a few
  things containers really help with.
